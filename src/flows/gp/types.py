...
class GroupVectorInput(ExprValue):
    """Terminal-only row expression safe to capture inside group vector RHS."""


class GroupKeyInput(ExprValue):
    """Terminal-only bounded key carrying explicit ``Key`` cardinality hints."""
