...
// Worker-state combination is part of the native runtime contract rather than
// generated orchestration. The runner supplies the physical-stage topology;
// the templates below select and inline each stage's merge law at compile time.
namespace stackdsl {
